...
const JobCard = ({ job }: Props) => {
  return (
    <div className="relative w-full border border-gray-300 dark:border-gray-700 rounded-xl p-4 sm:p-6 overflow-hidden">
      {/* Bookmark */}
      <button className="absolute top-4 right-4 w-8 h-8 flex items-center justify-center rounded-full hover:bg-gray-600 dark:hover:bg-gray-800 transition-all duration-200">
