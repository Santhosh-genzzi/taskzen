...
const Logo = () => {
  return (
    <Link href="/" className='flex items-center gap-3 group'>
        ...
        <p className='sm:block font-semibold text-lg md:text-xl tracking-wide text-black dark:text-gray-300 group-hover:text-primary transition-colors duration-300'>
            TaskZen
        </p>
